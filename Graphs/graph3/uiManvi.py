...
from metal_loss_plot import plot_metal_loss  # Metal Loss Plot function
...
class GraphApp(QWidget):
    def __init__(self):
        ...
        self.graph_type.addItems(["", "Metal Loss", "ERF", "Psafe", "Depth", "Orientation"])
        ...
        self.feature_identification.addItems(["", "Corrosion", "MFG", "Both"])
        ...
        try:
            ...
            if graph_type == "Metal Loss":
                ...
                if not feature and dimension == "":
                    self.file_label.setText("Please select either Feature Identification or Dimensional Classification for Metal Loss.")
                    return
